import type { JobSource, JobStatus, PostingState } from "@/lib/db/schema";

/**
 * Presentational mappings that turn raw database enums into human-facing labels
 * and soft, color-coded tones. Keep all "how does this look to a person" logic
 * here so the UI never leaks schema values. See DESIGN.md.
 */
